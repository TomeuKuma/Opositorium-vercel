...
# Se usa el comando 'python manage.py clear_supabase_tests'
...
class Command(BaseCommand):
    help = "Vacía la base de datos de preguntas y reinicia el contador de ID en PostgreSQL. Se usa el comando 'python manage.py clear_supabase_tests'"
