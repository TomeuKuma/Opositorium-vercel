...
class AnuncioBoibProcesado(models.Model):
    ...
    isla = models.CharField(max_length=255)
    numero_anuncio = models.CharField(max_length=255, blank=True, null=True)
    ...
    tipo_turno = models.CharField(max_length=255, blank=True, null=True)
    tipo_personal = models.CharField(max_length=255, blank=True, null=True)
    fase_proceso = models.CharField(max_length=255, blank=True, null=True)
